...
import type { Office } from "@/lib/constants";
import { cn } from "@/lib/utils";

export type OfficesGlobalClientProps = {
 ...
 *
 * `offices` comes from the server-side `OfficesGlobal` wrapper (Sanity-managed
 * with a hardcoded fallback) — this component itself is purely presentational.
 */
export function OfficesGlobalClient({ offices, defaultActive = "uae" }: OfficesGlobalClientProps) {
