  ...
  return (
    <section className="relative w-full px-6 py-10 md:px-6 md:py-12 lg:px-12 lg:py-16 xl:px-12 xl:py-20">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        {/* Left column — photo + brand red overlay + headline. `self-start`
            keeps the photo at its own natural height (inner min-h below): it
            matches the collapsed form, and does NOT grow when accordion steps
            expand — the form simply extends past it. */}
        <div className="bg-brand-red text-surface relative overflow-hidden lg:self-start">
